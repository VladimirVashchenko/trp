...
<form action="<?php echo JRoute::_('index.php?option=com_helloworld&view=helloworlds'); ?>" method="post" id="adminForm"
      name="adminForm">
            ...
            <table class="table table-striped table-hover">
                ...
                <?php if (!empty($this->items)) : ?>
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        $canChange = $user->authorise('core.edit.state', 'com_helloworld') && $canCheckin;
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <?php echo JHtml::_('jgrid.published', $item->state, $i, 'helloworlds.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                            </td>
                            <td>
